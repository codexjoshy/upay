...
//    }
  ...
  $demoSettings.append(
	...
	+ '<label htmlFor="toggle_left_sidebar_skin" class="control-sidebar-subheading">'
    + 'Dark or Light Skin'
    + '</label>'
	+ '<label class="switch">'
  ...
  $demoSettings.append(
	...
	+ '<label htmlFor="rtl" class="control-sidebar-subheading">'
    + 'Turn RTL/LTR'
    + '</label>'
  ...
  $demoSettings.append(
	...
	+ '<label htmlFor="toggle_sidebar" class="control-sidebar-subheading">'
    + 'Toggle Sidebar'
    + '</label>'
	+ '<label class="switch switch-border switch-danger">'
	...
	+ '<div class="flexbox mb-10">'
	+ '<label htmlFor="toggle_right_sidebar" class="control-sidebar-subheading">'
  ...
  var $themePrimary =
        $('<li />', { style: 'padding: 5px;' })
          .append('<a href="#" data-theme="theme-primary" style="background: #5A8DEE; display: block;vertical-align: middle;" class="clearfix rounded w-p100 h-30 mb-5" title="Theme primary">'
            + '</a>')
  $skinsList.append($themePrimary)

  var $themeSecondary =
        $('<li />', { style: 'padding: 5px;' })
          .append('<a href="#" data-theme="theme-secondary" style="background: #475F7B; display: block;vertical-align: middle;" class="clearfix rounded w-p100 h-30 mb-5" title="Theme secondary">'
            + '</a>')
  $skinsList.append($themeSecondary)

  var $themeInfo =
        $('<li />', { style: 'padding: 5px;' })
          .append('<a href="#" data-theme="theme-info" style="background: #00CFDD; display: block;vertical-align: middle;" class="clearfix rounded w-p100 h-30 mb-5" title="Theme info">'
            + '</a>')
  $skinsList.append($themeInfo)

  var $themeSuccess =
        $('<li />', { style: 'padding: 5px;' })
          .append('<a href="#" data-theme="theme-success" style="background: #39DA8A; display: block;vertical-align: middle;" class="clearfix rounded w-p100 h-30 mb-5" title="Theme success">'
            + '</a>')
  $skinsList.append($themeSuccess)

  var $themeDanger =
        $('<li />', { style: 'padding: 5px;' })
          .append('<a href="#" data-theme="theme-danger" style="background: #FF5B5C; display: block;vertical-align: middle;" class="clearfix rounded w-p100 h-30 mb-5" title="Theme danger">'
            + '</a>')
  $skinsList.append($themeDanger)

  var $themeWarning =
        $('<li />', { style: 'padding: 5px;' })
          .append('<a href="#" data-theme="theme-warning" style="background: #FDAC41; display: block;vertical-align: middle;" class="clearfix rounded w-p100 h-30 mb-5" title="Theme warning">'
            + '</a>')
